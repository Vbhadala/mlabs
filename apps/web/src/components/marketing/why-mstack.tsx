...
const pillars = [
  {
    ...
    bullets: [
      "/mstack:mstack-plan refuses to skip the persona + wedge + scope conversation.",
      "/mstack:mstack-review locks decisions and raises blockers before any code is written.",
      "/mstack:mstack-code pauses on destructive migrations, new deps, and brand/design changes.",
      "/mstack:mstack-qa drives Playwright through the flows before merge.",
    ],
    icon: <ShieldIcon />,
  },
  {
    ...
    bullets: [
      ...
      "One atomic commit per task in /mstack:mstack-code → bisectable history.",
    ],
    icon: <RulerIcon />,
  },
  {
